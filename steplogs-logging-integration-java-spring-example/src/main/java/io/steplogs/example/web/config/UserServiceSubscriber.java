...
@Configuration
public class UserServiceSubscriber<T> extends AbstractServiceSubscriber implements ServiceClientTemplate<Return<T>> {
	...
	@Override
	public Return<T> getDefaultErrorResponse() {
		return Return.Error("Internal Service Error");
	}
